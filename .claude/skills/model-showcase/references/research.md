...
| Usage scope | No — the example still gets built | Checked independently of the licence gate. Any restriction statement is recorded verbatim in the research table, and must carry into `model-report`'s `report.md` and `social.md`. |
