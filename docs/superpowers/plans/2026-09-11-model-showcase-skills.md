...
**Goal:** Build `ui-house-style` and `model-showcase` so that `examples/showcase/speaker-diarization-vibevoice` can be generated from a model name rather than hand-written.
...
| File | Action | Responsibility |
|---|---|---|
| `examples/showcase/speaker-diarization-vibevoice/**` | create | generated by `model-showcase` in Task 13 |
...
**Files:**
- Create: `examples/showcase/speaker-diarization-vibevoice/model-compose.yml`
- Create: `examples/showcase/speaker-diarization-vibevoice/ui/**`
- Create: `examples/showcase/speaker-diarization-vibevoice/README.md`, `README.ko.md`, `README.zh-cn.md`
- Create: `examples/showcase/speaker-diarization-vibevoice/.gitignore`
...
for size in "1440 900" "800 900" "390 844"; do
  set -- $size
  node .claude/skills/model-showcase/assets/ui-check.mjs \
    examples/showcase/speaker-diarization-vibevoice/ui --width=$1 --height=$2
done
```
...
```bash
rm -rf examples/showcase/speaker-diarization-vibevoice
```
...
```bash
git add examples/showcase/speaker-diarization-vibevoice examples/README.md
git commit -F - <<'EOF'
...
**Files:**
- Modify: `examples/showcase/speaker-diarization-vibevoice/ui/fixture.json`
- Modify: `examples/showcase/speaker-diarization-vibevoice/README.md`, `README.ko.md`, `README.zh-cn.md` (any figure marked `needs verification`)
...
```bash
git add examples/showcase/speaker-diarization-vibevoice
git commit -F - <<'EOF'
